...
# directories
mkdir -p pgdata esdata nginx kibana elasticsearch geonetwork && \
...
cp -rf /home/ec2-user/docker-geonetwork/odi-customisations/geonetwork/* /home/ec2-user/geonetwork  && \
cp -rf /home/ec2-user/docker-geonetwork/elasticsearch/* /home/ec2-user/elasticsearch  && \

chown -Rf ec2-user:ec2-user pgdata esdata nginx kibana elasticsearch schemas geonetwork
