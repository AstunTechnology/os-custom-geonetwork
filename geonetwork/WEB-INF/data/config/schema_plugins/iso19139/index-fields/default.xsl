...
-->
  ...
  <!-- Index mode template for OS NGD Keywords thesaurus -->

  <xsl:template mode="index"
      match="gmd:MD_Keywords[gmd:thesaurusName/gmd:CI_Citation/
                  gmd:title/gmx:Anchor='Ordnance Survey NGD vocabulary']/
                  gmd:keyword[normalize-space(gmx:Anchor/@xlink:href) != '']">
      <Field name="ngdKeyword" string="{string(normalize-space(gmx:Anchor/@xlink:href))}" store="true" index="true"/>
  </xsl:template>
