    ...
    function ($scope, $http, gnGlobalSettings) {
      ...
      var dashboards = [{
        ...
        href: '#/dashboard/statistics?dashboard=' +
            encodeURIComponent('../../dashboards/app/dashboards?auth_provider_hint=anonymous1#/view/' +
             '853fef90-8dce-11e9-9bb7-5db216293bad?embed=true&_g=(filters%3A!()%2CrefreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-5y%2Cto%3Anow))&show-time-filter=true')
      //TODO: The following dashboards need a rework
        ...
        href: '#/dashboard/statistics?dashboard=' +
            encodeURIComponent('../../dashboards/app/dashboards?auth_provider_hint=anonymous1#/view/' +
            '915983d0-2c2e-11e7-a889-7bfa00c573d3?embed=true&_g=(filters%3A!()%2CrefreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-5y%2Cto%3Anow))&show-time-filter=true')
      }, {
        type: 'statistics',
        ...
        href: '#/dashboard/statistics?dashboard=' +
            encodeURIComponent('../../dashboards/app/dashboards?auth_provider_hint=anonymous1#/view/' +
            '4b5edcf0-8be2-11eb-8255-7ba8c90e1ee6?embed=true&_g=(filters%3A!())&show-time-filter=true')
      }];
